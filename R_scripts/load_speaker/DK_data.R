...
setwd("/Users/Thomas/Documents/Hawaiian_Phonetics/KLHData/DK/output")
...
DK <- left_join(seg_info, formants, by="filename")


# Get list of .f0 files
setwd("/Users/Thomas/Documents/Hawaiian_Phonetics/KLHData/DK/output/sounds/")
...
DK <- left_join(DK, df, by="filename")

## Get new f0 measures instead of trusting the ones from FastTrack
## DK is now extracted with 70-290 as min and max in Praat
